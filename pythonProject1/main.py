...
from pythonProject1.Retry import *   #测试用例失败重试（报告去重）
from pythonProject1.ExcelUtil import *
from pythonProject1.MysqlUtil import *
from pythonProject1.PatternUtil import *
from pythonProject1.HttpReqUtil import *
...
if __name__ == '__main__':
    ...
    fileName = r"D:\app_testcase.xlsx"  # 测试报告excel文件路径
    # 获取测试用例数据列表
